...
export default function BottomTabNavigator() {
  ...
  return (
    <BottomTab.Navigator
      ...
      tabBarOptions={{ activeTintColor: Colors[colorScheme.type].tint }}
    >
      <BottomTab.Screen
        name="TabOne"
...
// You can ehttps://icons.expo.fyi/xplore the built-in icon families and icons on the web at:
//
  ...
  return (
    <SplashScreenStack.Navigator>
      <SplashScreenStack.Screen
        ...
        options={{ headerTitle: "Splash Screen" }}
      />
    </SplashScreenStack.Navigator>
  );
}
